...
-- Load settings
local lava_chance = core.settings:get("lava_chance") or 150
local gravel_chance = core.settings:get("gravel_chance") or 8
local glass_chance = core.settings:get("glass_chance") or 6
local damage_blast_resistant = core.settings:get("damage_blast_resistant") or 24
local glass_block_chance = core.settings:get("glass_block_chance") or 48
local melt_chance = core.settings:get("melt_chance") or 3
	...
	core.override_item(name, {
		on_blast = function(pos)
			if math.random(1, glass_block_chance) == 1 then
				core.set_node(pos, { name = "default:glass" })
				return
...
tnt_extras.register_blast_resistant("default:obsidianbrick", 0.9)
tnt_extras.register_blast_resistant("default:mese", 0.6)
tnt_extras.register_blast_resistant("default:desert_stonebrick", 0.35)
tnt_extras.register_blast_resistant("default:sandstonebrick", 0.35)
tnt_extras.register_blast_resistant("default:stonebrick", 0.35)
tnt_extras.register_blast_resistant("default:brick", 0.35)
tnt_extras.register_blast_resistant("default:cloud", 10)

-- Check if nyancats are registered
if core.registered_nodes["nyancat:nyancat"] ~= nil then
	tnt_extras.register_blast_resistant("nyancat:nyancat", 0.8)
	tnt_extras.register_blast_resistant("nyancat:nyancat_rainbow", 0.8)
elseif core.registered_nodes["default:nyancat"] ~= nil then
	tnt_extras.register_blast_resistant("default:nyancat", 0.8)
	tnt_extras.register_blast_resistant("default:nyancat_rainbow", 0.8)
end
